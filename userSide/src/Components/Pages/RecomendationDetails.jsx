...
export default function RecommendationDetails() {
  ...
  return (
    <div>
      <div className="bg-[#1F2937] p-6 flex justify-center items-center  ">
          ...
          <div className="md:w-2/3 p-6 flex flex-col justify-between">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <h2 className="text-md">Email: {userEmail}</h2>
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-500 mb-4">
              ...
              <span>Recommendations: {recommendationCount} </span>
            </div>
      ...
      {/* Recomendataion Comment */}

      <QueryComment id={details} />
      {/* Add Recomendation  */}
      <AddRecomendations details={details} />
    </div>
  );
}
